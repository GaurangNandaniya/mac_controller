...
def generate_camera_frames(fps):
    ...
    try:
        ...
        while True:
            ...
            # Yield as MJPEG multipart chunk
            yield (b'--frame\r\n'
...
@system_bp.route('/screen/stream', methods=['GET'])
def screen_stream():
